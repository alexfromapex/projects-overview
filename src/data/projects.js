...
export default [
    ...
    },
    {
        ...
        image: '',
        description: `I've previously held a job in image processing/computer vision at NIEHS. I found a keen interest in image processing algorithms. In my spare time, I have been experimenting the with OpenCV library's Python bindings.`,
        icon: 'fa-eye',
        link: `http://localhost`,
        link_text: `${read_more}`
    },
    {
        title: `Click Summit Conference Microsite`,
        image: '',
